...
const validateHeaders = validateSource(segments.HEADERS);
const validateParams = validateSource(segments.PARAMS);
const validateQuery = validateSource(segments.QUERY);
const validateCookies = validateSource(segments.COOKIES);
const validateSignedCookies = validateSource(segments.SIGNEDCOOKIES);
...
const REQ_VALIDATIONS = new Map([
  [segments.HEADERS, validateHeaders],
  [segments.PARAMS, validateParams],
  [segments.QUERY, validateQuery],
  [segments.COOKIES, validateCookies],
  [segments.SIGNEDCOOKIES, validateSignedCookies],
